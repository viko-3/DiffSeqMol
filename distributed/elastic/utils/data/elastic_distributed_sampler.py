...
class ElasticDistributedSampler(DistributedSampler):
    ...
    the datasets for elastic training.
    ...
    Args:
        ...
        start_index (optional):  Which index of the datasets to start sampling from
    """
    ...
    def __init__(self, dataset, num_replicas=None, rank=None, start_index=0):
        ...
        if start_index >= len(dataset):
            raise ValueError(
                "Start index {} should be less than datasets size {}".format(
