...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_reconstruct_pt', type=bool, default=False, help='train model based on reconstruct_pt')
    parser.add_argument('--load_reconstruct_pt', type=str,
                        default='diffusion_models/diffuseq_qqp_h128_lr0.0001_t200_sqrt_lossaware_seed102_qqp20230224-14:23:07/ema_0.9999_800000.pt',
                        help='path of reconstruct_pt')
    ...
    COMMANDLINE = f" OPENAI_LOGDIR={Model_FILE}  " \
                  ...
                  f"--use_reconstruct_pt {args.use_reconstruct_pt} " \
                  f"--load_reconstruct_pt {args.load_reconstruct_pt} "
